...
A única fonte executável do schema é `supabase/migrations/`, com **14 migrations timestampadas**: 10 migrations imutáveis da baseline greenfield (`20260812000100` a `20260812001000`) e evoluções pós-baseline (`20260812001100` a `20260819000100`). O intervalo completo é `20260812000100` a `20260819000100`.
...
1. Aplicar as 14 migrations em banco vazio.
