...
| **Recomendação** | Orientação oficial materializada quando o diagnóstico é consolidado, a partir de resposta negativa ou evidência exigida não aprovada. | Ação, plano de ação, sinal provisório. |
| **Plano de ação** | Conjunto de ações, responsáveis, prazos, comprovações da execução e acompanhamento para executar uma recomendação. | Recomendação. |
