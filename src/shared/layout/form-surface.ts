...
export const formSurface = {
  ...
  table: {
    ...
    head: "sticky top-0 z-10 border-b border-slate-100/80 bg-brand-50/95 text-left text-micro font-medium uppercase tracking-wider text-slate-900 backdrop-blur",
    headCell: "px-4 py-3",
  ...
  badge: {
    base: "inline-flex items-center rounded-md px-2 py-0.5 text-micro font-medium leading-snug",
  ...
  formWorkspace: {
    ...
    body: "space-y-6 px-4 py-6 sm:px-10 sm:py-8 lg:px-12",
    footer:
