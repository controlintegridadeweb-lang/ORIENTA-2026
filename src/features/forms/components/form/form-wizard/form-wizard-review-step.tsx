...
export function FormWizardReviewStep({ formId, formName, onReadinessChange }: Props) {
  ...
  return (
    <section className="max-w-3xl space-y-4">
      <div>
        <h3 className="text-base font-medium text-slate-900">Revisão e publicação</h3>
        <p className="mt-1 text-sm leading-relaxed text-slate-600">
          Confira o resumo antes de publicar. O formulário permanece em rascunho se você apenas
          salvar e sair.
        </p>
      </div>
      ...
      <div className="overflow-hidden rounded-xl border border-slate-200 bg-white">
        <div className="space-y-3 p-4">
          <h4 className="text-sm font-semibold text-slate-800">Resumo</h4>
        ...
        <div className="space-y-2 border-t border-slate-200 p-4">
          <h4 className="text-sm font-semibold text-slate-800">Checklist de publicação</h4>
        ...
        {pendingCount > 0 ? (
          ...
          <p className="border-t border-slate-200 px-4 py-3 text-sm text-emerald-800">
