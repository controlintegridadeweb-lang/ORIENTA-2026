...
export function FormQuestionCreateForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 border-b border-slate-100 pb-5">
      ...
      <div className={formSurface.fieldGroup}>
        <label htmlFor="new-question-section" className="text-sm font-medium text-slate-800">
          Seção da biblioteca
        </label>
        <select
