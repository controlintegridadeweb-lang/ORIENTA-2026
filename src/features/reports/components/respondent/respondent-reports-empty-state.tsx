...
> = {
  "no-reports": {
    ...
    body: "O PDF oficial aparecerá aqui depois que a administração concluir a validação e emitir o documento. Diagnósticos em andamento podem ser acompanhados no Dashboard e em Meus diagnósticos.",
    iconBg: "bg-slate-100",
