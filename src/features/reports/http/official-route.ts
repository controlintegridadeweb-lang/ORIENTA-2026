...
/**
 * Emissão administrativa do PDF oficial a partir de um diagnóstico com validação concluída e FAMI oficial.
...
export async function POST(request: Request) {
  ...
  try {
    const data = await loadOfficialReportData(payload);
    if (!data) {
