...
export function RecommendationActionsWorkspace() {
  ...
  if (row.recommendationStatus === "exception_requested") {
    return (
      ...
      >
        <h2 id="action-plan-exception-pending-title" className="font-semibold text-slate-800">
  ...
  if (row.recommendationStatus === "dismissed") {
    return (
      ...
      >
        <h2 id="action-plan-dismissed-title" className="font-semibold text-slate-800">
  ...
  if (!canManageActions && availability) {
    ...
    return (
      ...
      >
        <div>
          <h2 id="action-plan-availability-title" className="font-semibold text-slate-800">
            {availability.title}
          </h2>
