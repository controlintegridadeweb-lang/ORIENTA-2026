...
export const recommendationCardShell = {
  article:
    "group relative overflow-hidden rounded-xl border border-slate-200/80 bg-white shadow-card transition duration-200 ease-out hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-card-hover",
...
export const recommendationHierarchySurface = {
  ...
  axisHeader:
    "relative overflow-hidden rounded-xl border border-slate-200/70 bg-white px-4 py-3.5 shadow-sm sm:px-5 sm:py-4",
  axisEyebrow:
  ...
  sectionHeader:
    "flex items-center gap-3 border-b border-slate-200/80 pb-2",
